	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-sm-7">
					<% hs.getStaticShoppingCart(); %>
				</div>
			</div>
		</div>
		<button type="submit" class="btn btn-primary" onclick="window.location='orders.jsp'">
			Back
		</button>
		<form style='display: inline-block;' action='vieworder.jsp?id=<%=request.getParameter("id")%>' method='post'>
		...
		<form style='display: inline-block;' action='orders.jsp' method='post'>
		<input type="hidden" name="delOrder" value="<%=request.getParameter("id")%>">
